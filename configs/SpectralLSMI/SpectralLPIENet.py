cfg = dict(
    exp_name = "SpectralLSMI_SpectralLPIENet_ft_MobileSpectralAWB_misaligned",
    ...
    pretrained_weights = "experiments/Misalignedv3/Finetune/251022_193403_CanonR5_SpectralLPIENet_misaligned_v3_ft/best.pth",
