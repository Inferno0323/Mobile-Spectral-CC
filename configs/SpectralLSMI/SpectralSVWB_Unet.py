cfg = dict(
    exp_name = "SpectralLSMI_SpectralSVWB_Unet_ft_MobileSpectralAWB_misaligned",
    ...
    # pretrained_weights = "experiments/260217_152752_MobileSpectralAWB_SpectralSVWB_Unet/best.pth",
    pretrained_weights = "experiments/260218_215443_MobileSpectralAWB_CanonR5_SpectralSVWB_Unet_misaligned_finetuning/best.pth",
