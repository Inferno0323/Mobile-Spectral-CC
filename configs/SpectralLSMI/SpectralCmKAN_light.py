cfg = dict(
    exp_name = "SpectralLSMI_SpectralCmKAN_light_ft_MobileSpectralAWB_misaligned",
    ...
    pretrained_weights = "experiments/Misalignedv3/Finetune/251023_095741_CanonR5_SpectralCmKAN_light_misaligned_v3_ft/best.pth",
